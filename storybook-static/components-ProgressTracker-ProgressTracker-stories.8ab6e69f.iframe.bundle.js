...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [503],
  {
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./src/components/ProgressTracker/style.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".progressTracker-container * {\n  margin: 0;\n  padding: 0;\n}\n.progressTracker-container {\n  display: flex;\n  width: 100%;\n  align-items: center;\n  justify-content: center;\n}\n.progressTracker-step {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 40px 0 16px;\n  gap: 20px;\n  position: relative;\n}\n.progressTracker-track {\n  position: absolute;\n  top: 40px;\n  height: 8px;\n  width: 100%;\n}\n.progressTracker-step.active .progressTracker-track {\n  position: absolute;\n  top: 40px;\n  height: 8px;\n  width: 50%;\n  background-color: #0065ff;\n}\n\n.progressTracker-step.active .progressTracker-stepTilte {\n  color: var(--Blue-B300, #0065ff);\n}\n.progressTracker-step.active .progressTracker-stepCircle {\n  background-color: var(--Blue-B300, #0065ff);\n}\n\n.progressTracker-stepCircle {\n  width: 8px;\n  height: 8px;\n  background-color: #a5adba;\n  border-radius: 50%;\n}\n.progressTracker-stepTilte {\n  color: var(--neutral-light-n-300, #5e6c84);\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 600;\n  line-height: 16px;\n  white-space: nowrap;\n  padding: 0 8px;\n}\n",
          "",
          {
            version: 3,
            sources: ["webpack://./src/components/ProgressTracker/style.css"],
            names: [],
            mappings:
              "AAAA;EACE,SAAS;EACT,UAAU;AACZ;AACA;EACE,aAAa;EACb,WAAW;EACX,mBAAmB;EACnB,uBAAuB;AACzB;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,oBAAoB;EACpB,SAAS;EACT,kBAAkB;AACpB;AACA;EACE,kBAAkB;EAClB,SAAS;EACT,WAAW;EACX,WAAW;AACb;AACA;EACE,kBAAkB;EAClB,SAAS;EACT,WAAW;EACX,UAAU;EACV,yBAAyB;AAC3B;;AAEA;EACE,gCAAgC;AAClC;AACA;EACE,2CAA2C;AAC7C;;AAEA;EACE,UAAU;EACV,WAAW;EACX,yBAAyB;EACzB,kBAAkB;AACpB;AACA;EACE,0CAA0C;EAC1C,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;EACjB,mBAAmB;EACnB,cAAc;AAChB",
            sourcesContent: [
              ".progressTracker-container * {\r\n  margin: 0;\r\n  padding: 0;\r\n}\r\n.progressTracker-container {\r\n  display: flex;\r\n  width: 100%;\r\n  align-items: center;\r\n  justify-content: center;\r\n}\r\n.progressTracker-step {\r\n  display: flex;\r\n  flex-direction: column;\r\n  align-items: center;\r\n  padding: 40px 0 16px;\r\n  gap: 20px;\r\n  position: relative;\r\n}\r\n.progressTracker-track {\r\n  position: absolute;\r\n  top: 40px;\r\n  height: 8px;\r\n  width: 100%;\r\n}\r\n.progressTracker-step.active .progressTracker-track {\r\n  position: absolute;\r\n  top: 40px;\r\n  height: 8px;\r\n  width: 50%;\r\n  background-color: #0065ff;\r\n}\r\n\r\n.progressTracker-step.active .progressTracker-stepTilte {\r\n  color: var(--Blue-B300, #0065ff);\r\n}\r\n.progressTracker-step.active .progressTracker-stepCircle {\r\n  background-color: var(--Blue-B300, #0065ff);\r\n}\r\n\r\n.progressTracker-stepCircle {\r\n  width: 8px;\r\n  height: 8px;\r\n  background-color: #a5adba;\r\n  border-radius: 50%;\r\n}\r\n.progressTracker-stepTilte {\r\n  color: var(--neutral-light-n-300, #5e6c84);\r\n  font-size: 14px;\r\n  font-style: normal;\r\n  font-weight: 600;\r\n  line-height: 16px;\r\n  white-space: nowrap;\r\n  padding: 0 8px;\r\n}\r\n",
            ],
            sourceRoot: "",
    ...
    "./src/components/ProgressTracker/ProgressTracker.stories.tsx": (
      ...
      (__webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => ProgressTracker_stories,
          test: () => test,
        }));
      ...
      const ProgressTracker = ({ direction, stepTitles, activeStep = 1 }) =>
          react.createElement(
            "div",
            { className: "progressTracker-container" },
            stepTitles.map((stepTitle, index) =>
              react.createElement(
                ...
                react.createElement("span", {
                  ...
                  style: { backgroundColor: "" + (activeStep >= index ? "#0065FF" : "#A5ADBA") },
                }),
                activeStep <= stepTitles.length - 1
                  ? react.createElement("span", {
                      ...
                      style: {
                        left:
                          "" +
                          (activeStep === index && "ltr" === direction
                            ? "0px"
                            : (activeStep !== index && "ltr" === direction) ||
                                (activeStep === index && "rtl" === direction)
                              ? "auto"
                              : activeStep !== index && "rtl" === direction
                                ? "0px"
                                : "auto"),
                        ...
                        width:
                          "" +
                          (0 === index && activeStep === index
                            ? "0%"
                            : (0 === index && activeStep !== index) ||
                                activeStep === index ||
                                (activeStep > index && index + 1 === stepTitles.length)
                              ? "50%"
                              : "100%"),
                      },
                    })
                  : react.createElement(react.Fragment, null),
                react.createElement("h2", { className: "progressTracker-stepTilte" }, stepTitle),
              ),
            ),
          ),
        ProgressTracker_ProgressTracker = ProgressTracker;
      ProgressTracker.__docgenInfo = {
        description: "",
        methods: [],
      ...
      const ProgressTracker_stories = {
          title: "sep-panel-ui/ProgressTracker",
          component: ProgressTracker_ProgressTracker,
        },
        test = {
          args: {
            direction: "ltr",
