...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [873],
  {
    "./src/components/DatePicker/DayPicker.stories.tsx": (
      ...
      (__webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          GregorianInline: () => GregorianInline,
          JalaliInline: () => JalaliInline,
          MonthLabelComparison: () => MonthLabelComparison,
          ShamsiToMiladiOutput: () => ShamsiToMiladiOutput,
          __namedExportsOrder: () => __namedExportsOrder,
          default: () => DayPicker_stories,
        }));
      ...
      function DayPicker(props) {
        ...
        return react.createElement(
          "div",
          {
            className: `dayPicker-wrapper ${className || ""}`,
            style: { direction: cfg.direction },
          },
          label &&
            react.createElement("label", { htmlFor: id, className: "datePicker-label" }, label),
          react.createElement(CalendarCore.A, {
            ...
            maxDate,
            inline: !0,
            onSelectDate: (date) => onChange?.((0, valueUtils.IE)(date, cfg)),
          }),
        );
      }
      const DatePicker_DayPicker = DayPicker;
      ...
      const DayPicker_stories = {
          title: "Components/DayPicker",
          component: DatePicker_DayPicker,
        ...
        JalaliInline = {
          ...
          render: (args) => {
            ...
            return react.createElement(
              "div",
              null,
              react.createElement(DatePicker_DayPicker, { ...args, value, onChange: setValue }),
              value &&
                react.createElement(
                  "p",
          ...
          render: () => {
            ...
            return react.createElement(
              ...
              react.createElement(
                ...
                react.createElement(DatePicker_DayPicker, {
                  id: "d-name",
                  calendar: "jalali",
                  locale: "fa",
                  direction: "rtl",
          ...
          render: () => {
            ...
            return react.createElement(
              ...
              react.createElement(
                "p",
                { style: { fontSize: 13, marginBottom: 4 } },
                "تقویم شمسی — خروجی میلادی (string)",
              ),
              react.createElement(DatePicker_DayPicker, {
                id: "d-convert",
                calendar: "jalali",
      ...
      ((JalaliInline.parameters = {
        ...JalaliInline.parameters,
        docs: {
          ...JalaliInline.parameters?.docs,
          source: {
            originalSource:
              "{\n  args: {\n    id: 'jalali-day',\n    label: 'تاریخ شمسی',\n    calendar: 'jalali',\n    locale: 'fa',\n    direction: 'rtl'\n  },\n  render: args => {\n    const [value, setValue] = useState<Date | null>(null);\n    return <div>\r\n        <DayPicker {...args} value={value} onChange={setValue} />\r\n        {value && <p style={{\n        marginTop: 8,\n        fontSize: 13\n      }}>{value.toLocaleDateString('fa-IR')}</p>}\r\n      </div>;\n  }\n}",
            ...JalaliInline.parameters?.docs?.source,
          },
        },
      }),
        (GregorianInline.parameters = {
          ...GregorianInline.parameters,
          docs: {
            ...GregorianInline.parameters?.docs,
            source: {
              originalSource:
                "{\n  args: {\n    id: 'gregorian-day',\n    label: 'Pick a date',\n    calendar: 'gregorian',\n    locale: 'en',\n    direction: 'ltr'\n  },\n  render: args => {\n    const [value, setValue] = useState<Date | null>(null);\n    return <div>\r\n        <DayPicker {...args} value={value} onChange={setValue} />\r\n        {value && <p style={{\n        marginTop: 8,\n        fontSize: 13\n      }}>{value.toLocaleDateString('en-US')}</p>}\r\n      </div>;\n  }\n}",
              ...GregorianInline.parameters?.docs?.source,
            },
          },
        }),
        (MonthLabelComparison.parameters = {
          ...MonthLabelComparison.parameters,
          docs: {
            ...MonthLabelComparison.parameters?.docs,
            source: {
              originalSource:
                '{\n  render: () => {\n    const [v1, setV1] = useState<Date | null>(null);\n    const [v2, setV2] = useState<Date | null>(null);\n    return <div style={{\n      display: \'flex\',\n      gap: 24\n    }}>\r\n        <div>\r\n          <p style={{\n          fontSize: 13,\n          marginBottom: 4\n        }}>monthLabel = "name" (شهریور)</p>\r\n          <DayPicker id="d-name" calendar="jalali" locale="fa" direction="rtl" monthLabel="name" value={v1} onChange={setV1} />\r\n        </div>\r\n        <div>\r\n          <p style={{\n          fontSize: 13,\n          marginBottom: 4\n        }}>monthLabel = "number" (ماه ۶)</p>\r\n          <DayPicker id="d-num" calendar="jalali" locale="fa" direction="rtl" monthLabel="number" value={v2} onChange={setV2} />\r\n        </div>\r\n      </div>;\n  }\n}',
              ...MonthLabelComparison.parameters?.docs?.source,
            },
          },
        }),
        (ShamsiToMiladiOutput.parameters = {
          ...
          docs: {
            ...
            source: {
              originalSource:
                '{\n  render: () => {\n    const [value, setValue] = useState<string | null>(null);\n    return <div>\r\n        <p style={{\n        fontSize: 13,\n        marginBottom: 4\n      }}>تقویم شمسی — خروجی میلادی (string)</p>\r\n        <DayPicker<"string"> id="d-convert" calendar="jalali" locale="fa" direction="rtl" format="YYYY/MM/DD" output="string" outputCalendar="gregorian" outputFormat="YYYY-MM-DD" value={value} onChange={v => setValue(v)} />\r\n        {value && <pre style={{\n        marginTop: 8,\n        fontSize: 12,\n        direction: \'ltr\'\n      }}>{value}</pre>}\r\n      </div>;\n  }\n}',
