    ...
    "./src/components/Button/Button.stories.tsx": (
      ...
      (__webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          primary: () => primary,
          secondary: () => secondary,
          subtelLink: () => subtelLink,
          subtle: () => subtle,
          warning: () => warning,
        }));
      const __WEBPACK_DEFAULT_EXPORT__ = {
        title: "sep-panel-ui/Button",
        component: __webpack_require__("./src/components/Button/Button.tsx").A,
      };
      const base = {
          args: {
            label: "base button",
      ...
      ((base.parameters = {
        ...
        (subtelLink.parameters = {
          ...subtelLink.parameters,
          docs: {
            ...subtelLink.parameters?.docs,
            source: {
              originalSource:
                '{\n  args: {\n    label: "subtleLink button",\n    loading: false,\n    colorType: "subtleLink",\n    fistIconSrc: "https://www.svgrepo.com/show/532036/cloud-rain-alt.svg"\n  }\n}',
              ...subtelLink.parameters?.docs?.source,
            },
          },
        }),
        (disabled.parameters = {
        ...
        (more.parameters = {
          ...more.parameters,
          docs: {
            ...more.parameters?.docs,
            source: {
              originalSource:
                '{\n  args: {\n    label: "more button",\n    colorType: "base",\n    fistIconSrc: "https://www.svgrepo.com/show/532036/cloud-rain-alt.svg",\n    hasMore: true\n  }\n}',
              ...more.parameters?.docs?.source,
            },
          },
        }));
    },
