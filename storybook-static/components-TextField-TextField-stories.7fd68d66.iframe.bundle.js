...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [188],
  {
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./src/components/TextField/style.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".textField-container {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  width: 100%;\n  gap: 4px;\n  box-sizing: border-box;\n  /* direction: rtl; */\n}\n\n/* Full Width */\n.textField-fullWidth {\n  width: 100%;\n}\n\n/* Sizes */\n.textField-sm .textField-input {\n  height: 32px;\n  padding: 6px;\n}\n\n.textField-sm .textField-inputElement {\n  font-size: 12px;\n}\n\n.textField-md .textField-input {\n  height: 40px;\n  padding: 8px;\n}\n\n.textField-md .textField-inputElement {\n  font-size: 14px;\n}\n\n.textField-lg .textField-input {\n  height: 48px;\n  padding: 12px;\n}\n\n.textField-lg .textField-inputElement {\n  font-size: 16px;\n}\n\n/* Variants */\n.textField-outlined .textField-input {\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\n  background: var(--neutral-light-n-10, #fafbfc);\n}\n\n.textField-filled .textField-input {\n  border: none;\n  border-bottom: 2px solid var(--neutral-light-n-40, #dfe1e6);\n  background: var(--neutral-light-n-20, #f4f5f7);\n  border-radius: 4px 4px 0 0;\n}\n\n.textField-standard .textField-input {\n  border: none;\n  border-bottom: 1px solid var(--neutral-light-n-40, #dfe1e6);\n  background: transparent;\n  border-radius: 0;\n}\n\n/* Colors */\n.textField-primary .textField-input:focus-within {\n  border-color: var(--Blue-B100, #4c9aff);\n}\n\n.textField-secondary .textField-input:focus-within {\n  border-color: var(--Purple-P100, #8b5cf6);\n}\n\n.textField-error .textField-input:focus-within {\n  border-color: var(--Red-R400, #de350b);\n}\n\n.textField-warning .textField-input:focus-within {\n  border-color: var(--Yellow-Y400, #ffab00);\n}\n\n.textField-success .textField-input:focus-within {\n  border-color: var(--Green-G400, #00875a);\n}\n.textField-container .textField-label {\n  color: var(--neutral-light-n-200, #6b778c);\n  font-size: 12px;\n  font-style: normal;\n  font-weight: 600;\n  line-height: 16px;\n}\n\n.textField-required {\n  color: var(--Red-R400, #de350b);\n}\n.textField-container .textField-input {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 8px;\n  height: 40px;\n  border-radius: 4px;\n  background: var(--neutral-light-n-10, #fafbfc);\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\n  gap: 6px;\n  transition: all 0.2s ease-in-out;\n  cursor: text;\n  position: relative;\n}\n\n/* Disabled state cursor */\n.textField-container .textField-input.disabled {\n  cursor: not-allowed;\n}\n\n/* Read-only state cursor */\n.textField-container .textField-input.readOnly {\n  cursor: default;\n}\n\n.textField-container .textField-inputElement {\n  outline: none;\n  border: none;\n  width: 100%;\n  color: var(--neutral-light-n-100, #7a869a);\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 20px;\n  background-color: rgba(0, 0, 0, 0);\n  flex: 1;\n  min-width: 0;\n  cursor: text;\n}\n\n/* Focus state */\n.textField-input.focused {\n  box-shadow: 0 0 0 2px rgba(76, 154, 255, 0.2);\n}\n\n/* Read-only state */\n.textField-input.readOnly {\n  background: var(--neutral-light-n-20, #f4f5f7);\n  cursor: default;\n}\n\n.textField-input.readOnly .textField-inputElement {\n  cursor: default;\n}\n\n.textField-container .textField-inputElement {\n  outline: none;\n  border: none;\n  width: 100%;\n  color: var(--neutral-light-n-100, #7a869a);\n  font-size: 14px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 20px;\n  background-color: rgba(0, 0, 0, 0);\n  flex: 1;\n  min-width: 0;\n}\n\n/* Icon styles */\n.textField-icon {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-width: 24px;\n  min-height: 24px;\n}\n\n.textField-startIcon {\n  order: -1;\n}\n\n.textField-endIcon {\n  order: 1;\n}\n\n.textField-container .textField-input img {\n  width: 24px;\n  height: 24px;\n}\n\n.textField-container .textField-message {\n  display: flex;\n  width: 100%;\n  align-items: center;\n  gap: 2px;\n}\n\n.textField-container .textField-input.errorMessage {\n  border: 2px solid var(--Red-R400, #de350b);\n}\n\n.textField-container .textField-guidMessage,\n.textField-container .textField-successMessage,\n.textField-container .textField-errorMessage {\n  font-size: 12px;\n  font-style: normal;\n  font-weight: 400;\n  line-height: 20px;\n  width: 100%;\n}\n.textField-container .textField-guidMessage {\n  color: var(--neutral-light-n-100, #7a869a);\n}\n.textField-container .textField-successMessage {\n  color: var(--Green-G400, #00875a);\n}\n.textField-container .textField-errorMessage {\n  color: var(--Red-R400, #de350b);\n}\n.textField-container .textField-guidIcon {\n  width: 16px;\n  height: 16px;\n  filter: brightness(0) saturate(100%) invert(52%) sepia(8%) saturate(773%)\n    hue-rotate(177deg) brightness(99%) contrast(94%);\n}\n.textField-container .textField-successIcon {\n  width: 16px;\n  height: 16px;\n  filter: brightness(0) saturate(100%) invert(37%) sepia(52%) saturate(887%)\n    hue-rotate(113deg) brightness(94%) contrast(100%);\n}\n.textField-container .textField-errorIcon {\n  width: 16px;\n  height: 16px;\n  filter: brightness(0) saturate(100%) invert(21%) sepia(90%) saturate(3998%)\n    hue-rotate(9deg) brightness(96%) contrast(91%);\n}\n\n.textField-container .textField-input:hover {\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\n  background: var(--neutral-light-n-30, #ebecf0);\n}\n.textField-container .textField-input:focus-within {\n  background: var(--neutral-light-no, #fff);\n  border: 2px solid var(--Blue-B100, #4c9aff);\n}\n\n.textField-container .textField-input.disabled {\n  background: var(--neutral-light-n-10, #fafbfc);\n  border-color: var(--neutral-light-n-30, #ebecf0);\n  cursor: not-allowed;\n}\n\n.textField-container .textField-input.disabled .textField-inputElement {\n  color: var(--neutral-light-n-70, #a5adba);\n  cursor: not-allowed;\n}\n\n.textField-container .textField-input.disabled img {\n  filter: brightness(0) saturate(100%) invert(73%) sepia(12%) saturate(263%)\n    hue-rotate(176deg) brightness(92%) contrast(92%);\n}\n\n.textField-container .textField-input.disabled .textField-icon {\n  cursor: not-allowed;\n}\n",
          "",
          {
            version: 3,
            sources: ["webpack://./src/components/TextField/style.css"],
            names: [],
            mappings:
              "AAAA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,WAAW;EACX,QAAQ;EACR,sBAAsB;EACtB,oBAAoB;AACtB;;AAEA,eAAe;AACf;EACE,WAAW;AACb;;AAEA,UAAU;AACV;EACE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,aAAa;AACf;;AAEA;EACE,eAAe;AACjB;;AAEA,aAAa;AACb;EACE,oDAAoD;EACpD,8CAA8C;AAChD;;AAEA;EACE,YAAY;EACZ,2DAA2D;EAC3D,8CAA8C;EAC9C,0BAA0B;AAC5B;;AAEA;EACE,YAAY;EACZ,2DAA2D;EAC3D,uBAAuB;EACvB,gBAAgB;AAClB;;AAEA,WAAW;AACX;EACE,uCAAuC;AACzC;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,sCAAsC;AACxC;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,wCAAwC;AAC1C;AACA;EACE,0CAA0C;EAC1C,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,+BAA+B;AACjC;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,YAAY;EACZ,YAAY;EACZ,kBAAkB;EAClB,8CAA8C;EAC9C,oDAAoD;EACpD,QAAQ;EACR,gCAAgC;EAChC,YAAY;EACZ,kBAAkB;AACpB;;AAEA,0BAA0B;AAC1B;EACE,mBAAmB;AACrB;;AAEA,2BAA2B;AAC3B;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,WAAW;EACX,0CAA0C;EAC1C,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;EACjB,kCAAkC;EAClC,OAAO;EACP,YAAY;EACZ,YAAY;AACd;;AAEA,gBAAgB;AAChB;EACE,6CAA6C;AAC/C;;AAEA,oBAAoB;AACpB;EACE,8CAA8C;EAC9C,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,YAAY;EACZ,WAAW;EACX,0CAA0C;EAC1C,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;EACjB,kCAAkC;EAClC,OAAO;EACP,YAAY;AACd;;AAEA,gBAAgB;AAChB;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,QAAQ;AACV;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;EACb,WAAW;EACX,mBAAmB;EACnB,QAAQ;AACV;;AAEA;EACE,0CAA0C;AAC5C;;AAEA;;;EAGE,eAAe;EACf,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;EACjB,WAAW;AACb;AACA;EACE,0CAA0C;AAC5C;AACA;EACE,iCAAiC;AACnC;AACA;EACE,+BAA+B;AACjC;AACA;EACE,WAAW;EACX,YAAY;EACZ;oDACkD;AACpD;AACA;EACE,WAAW;EACX,YAAY;EACZ;qDACmD;AACrD;AACA;EACE,WAAW;EACX,YAAY;EACZ;kDACgD;AAClD;;AAEA;EACE,oDAAoD;EACpD,8CAA8C;AAChD;AACA;EACE,yCAAyC;EACzC,2CAA2C;AAC7C;;AAEA;EACE,8CAA8C;EAC9C,gDAAgD;EAChD,mBAAmB;AACrB;;AAEA;EACE,yCAAyC;EACzC,mBAAmB;AACrB;;AAEA;EACE;oDACkD;AACpD;;AAEA;EACE,mBAAmB;AACrB",
            sourcesContent: [
              ".textField-container {\r\n  display: flex;\r\n  flex-direction: column;\r\n  justify-content: center;\r\n  width: 100%;\r\n  gap: 4px;\r\n  box-sizing: border-box;\r\n  /* direction: rtl; */\r\n}\r\n\r\n/* Full Width */\r\n.textField-fullWidth {\r\n  width: 100%;\r\n}\r\n\r\n/* Sizes */\r\n.textField-sm .textField-input {\r\n  height: 32px;\r\n  padding: 6px;\r\n}\r\n\r\n.textField-sm .textField-inputElement {\r\n  font-size: 12px;\r\n}\r\n\r\n.textField-md .textField-input {\r\n  height: 40px;\r\n  padding: 8px;\r\n}\r\n\r\n.textField-md .textField-inputElement {\r\n  font-size: 14px;\r\n}\r\n\r\n.textField-lg .textField-input {\r\n  height: 48px;\r\n  padding: 12px;\r\n}\r\n\r\n.textField-lg .textField-inputElement {\r\n  font-size: 16px;\r\n}\r\n\r\n/* Variants */\r\n.textField-outlined .textField-input {\r\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\r\n  background: var(--neutral-light-n-10, #fafbfc);\r\n}\r\n\r\n.textField-filled .textField-input {\r\n  border: none;\r\n  border-bottom: 2px solid var(--neutral-light-n-40, #dfe1e6);\r\n  background: var(--neutral-light-n-20, #f4f5f7);\r\n  border-radius: 4px 4px 0 0;\r\n}\r\n\r\n.textField-standard .textField-input {\r\n  border: none;\r\n  border-bottom: 1px solid var(--neutral-light-n-40, #dfe1e6);\r\n  background: transparent;\r\n  border-radius: 0;\r\n}\r\n\r\n/* Colors */\r\n.textField-primary .textField-input:focus-within {\r\n  border-color: var(--Blue-B100, #4c9aff);\r\n}\r\n\r\n.textField-secondary .textField-input:focus-within {\r\n  border-color: var(--Purple-P100, #8b5cf6);\r\n}\r\n\r\n.textField-error .textField-input:focus-within {\r\n  border-color: var(--Red-R400, #de350b);\r\n}\r\n\r\n.textField-warning .textField-input:focus-within {\r\n  border-color: var(--Yellow-Y400, #ffab00);\r\n}\r\n\r\n.textField-success .textField-input:focus-within {\r\n  border-color: var(--Green-G400, #00875a);\r\n}\r\n.textField-container .textField-label {\r\n  color: var(--neutral-light-n-200, #6b778c);\r\n  font-size: 12px;\r\n  font-style: normal;\r\n  font-weight: 600;\r\n  line-height: 16px;\r\n}\r\n\r\n.textField-required {\r\n  color: var(--Red-R400, #de350b);\r\n}\r\n.textField-container .textField-input {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n  padding: 8px;\r\n  height: 40px;\r\n  border-radius: 4px;\r\n  background: var(--neutral-light-n-10, #fafbfc);\r\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\r\n  gap: 6px;\r\n  transition: all 0.2s ease-in-out;\r\n  cursor: text;\r\n  position: relative;\r\n}\r\n\r\n/* Disabled state cursor */\r\n.textField-container .textField-input.disabled {\r\n  cursor: not-allowed;\r\n}\r\n\r\n/* Read-only state cursor */\r\n.textField-container .textField-input.readOnly {\r\n  cursor: default;\r\n}\r\n\r\n.textField-container .textField-inputElement {\r\n  outline: none;\r\n  border: none;\r\n  width: 100%;\r\n  color: var(--neutral-light-n-100, #7a869a);\r\n  font-size: 14px;\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  line-height: 20px;\r\n  background-color: rgba(0, 0, 0, 0);\r\n  flex: 1;\r\n  min-width: 0;\r\n  cursor: text;\r\n}\r\n\r\n/* Focus state */\r\n.textField-input.focused {\r\n  box-shadow: 0 0 0 2px rgba(76, 154, 255, 0.2);\r\n}\r\n\r\n/* Read-only state */\r\n.textField-input.readOnly {\r\n  background: var(--neutral-light-n-20, #f4f5f7);\r\n  cursor: default;\r\n}\r\n\r\n.textField-input.readOnly .textField-inputElement {\r\n  cursor: default;\r\n}\r\n\r\n.textField-container .textField-inputElement {\r\n  outline: none;\r\n  border: none;\r\n  width: 100%;\r\n  color: var(--neutral-light-n-100, #7a869a);\r\n  font-size: 14px;\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  line-height: 20px;\r\n  background-color: rgba(0, 0, 0, 0);\r\n  flex: 1;\r\n  min-width: 0;\r\n}\r\n\r\n/* Icon styles */\r\n.textField-icon {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  min-width: 24px;\r\n  min-height: 24px;\r\n}\r\n\r\n.textField-startIcon {\r\n  order: -1;\r\n}\r\n\r\n.textField-endIcon {\r\n  order: 1;\r\n}\r\n\r\n.textField-container .textField-input img {\r\n  width: 24px;\r\n  height: 24px;\r\n}\r\n\r\n.textField-container .textField-message {\r\n  display: flex;\r\n  width: 100%;\r\n  align-items: center;\r\n  gap: 2px;\r\n}\r\n\r\n.textField-container .textField-input.errorMessage {\r\n  border: 2px solid var(--Red-R400, #de350b);\r\n}\r\n\r\n.textField-container .textField-guidMessage,\r\n.textField-container .textField-successMessage,\r\n.textField-container .textField-errorMessage {\r\n  font-size: 12px;\r\n  font-style: normal;\r\n  font-weight: 400;\r\n  line-height: 20px;\r\n  width: 100%;\r\n}\r\n.textField-container .textField-guidMessage {\r\n  color: var(--neutral-light-n-100, #7a869a);\r\n}\r\n.textField-container .textField-successMessage {\r\n  color: var(--Green-G400, #00875a);\r\n}\r\n.textField-container .textField-errorMessage {\r\n  color: var(--Red-R400, #de350b);\r\n}\r\n.textField-container .textField-guidIcon {\r\n  width: 16px;\r\n  height: 16px;\r\n  filter: brightness(0) saturate(100%) invert(52%) sepia(8%) saturate(773%)\r\n    hue-rotate(177deg) brightness(99%) contrast(94%);\r\n}\r\n.textField-container .textField-successIcon {\r\n  width: 16px;\r\n  height: 16px;\r\n  filter: brightness(0) saturate(100%) invert(37%) sepia(52%) saturate(887%)\r\n    hue-rotate(113deg) brightness(94%) contrast(100%);\r\n}\r\n.textField-container .textField-errorIcon {\r\n  width: 16px;\r\n  height: 16px;\r\n  filter: brightness(0) saturate(100%) invert(21%) sepia(90%) saturate(3998%)\r\n    hue-rotate(9deg) brightness(96%) contrast(91%);\r\n}\r\n\r\n.textField-container .textField-input:hover {\r\n  border: 2px solid var(--neutral-light-n-40, #dfe1e6);\r\n  background: var(--neutral-light-n-30, #ebecf0);\r\n}\r\n.textField-container .textField-input:focus-within {\r\n  background: var(--neutral-light-no, #fff);\r\n  border: 2px solid var(--Blue-B100, #4c9aff);\r\n}\r\n\r\n.textField-container .textField-input.disabled {\r\n  background: var(--neutral-light-n-10, #fafbfc);\r\n  border-color: var(--neutral-light-n-30, #ebecf0);\r\n  cursor: not-allowed;\r\n}\r\n\r\n.textField-container .textField-input.disabled .textField-inputElement {\r\n  color: var(--neutral-light-n-70, #a5adba);\r\n  cursor: not-allowed;\r\n}\r\n\r\n.textField-container .textField-input.disabled img {\r\n  filter: brightness(0) saturate(100%) invert(73%) sepia(12%) saturate(263%)\r\n    hue-rotate(176deg) brightness(92%) contrast(92%);\r\n}\r\n\r\n.textField-container .textField-input.disabled .textField-icon {\r\n  cursor: not-allowed;\r\n}\r\n",
            ],
            sourceRoot: "",
    ...
    "./src/components/TextField/TextField.stories.tsx": (
      ...
      const info_namespaceObject = __webpack_require__.p + "static/media/info.676fae83.svg",
        success_namespaceObject = __webpack_require__.p + "static/media/success.51409fb5.svg",
        error_namespaceObject = __webpack_require__.p + "static/media/error.4d2ca2da.svg",
        TextField = ({
          type,
          direction,
          label,
          ...
          const [internalValue, setInternalValue] = (0, react.useState)(value?.toString() || ""),
            [validationError, setValidationError] = (0, react.useState)(""),
          ...
          const validateInput = (inputValue) => {
              ...
              if (validationRules)
                for (const rule of validationRules) if (!rule.rule(inputValue)) return rule.message;
              return "";
            },
            parseValue = (inputValue) => (parser ? parser(inputValue) : inputValue),
            handleIconClick = () => {
              iconClick && iconClick();
            },
            currentErrorMessage = errorMessage || validationError,
            currentSuccessMessage = successMessage,
            currentGuidMessage = guidMessage;
          return react.createElement(
            ...
            label &&
              react.createElement(
                "label",
                { htmlFor: id, className: "textField-label" },
                label,
                required && react.createElement("span", { className: "textField-required" }, " *"),
              ),
            react.createElement(
              "div",
              {
                ...
                onClick: () => {
                  !inputRef.current || disabled || readOnly || inputRef.current.focus();
                },
              },
              (firstIconSrc || (startIcon && "start" === iconPosition)) &&
                react.createElement(
                  "div",
                  {
                    ...
                    onClick: iconClick ? handleIconClick : void 0,
                    style: { cursor: iconClick ? "pointer" : "default" },
                  },
                  firstIconSrc
                    ? react.createElement("img", { src: firstIconSrc, alt: "start icon for input" })
                    : startIcon,
                ),
              react.createElement("input", {
                ref: inputRef,
                type,
                className: `textField-inputElement ${className || ""}`,
                id,
                name,
                ...
                onChange: (event) => {
                  ...
                  inputValue = ((inputValue) => {
                    ...
                    return (
                      allowOnlyNumbers && (formattedValue = formattedValue.replace(/[^0-9]/g, "")),
                      allowOnlyLetters &&
                        (formattedValue = formattedValue.replace(/[^a-zA-Z\u0600-\u06FF]/g, "")),
                      formatter && (formattedValue = formatter(formattedValue)),
                      formattedValue
                    );
                  })(inputValue);
                  const parsedValue = parseValue(inputValue);
                  if ((setInternalValue(inputValue), onChange(parsedValue), validateOnChange)) {
                    const error = validateInput(parsedValue);
                    setValidationError(error);
                  }
                },
                onFocus: (event) => {
                  (setIsFocused(!0), onFocus?.(event));
                },
                onBlur: (event) => {
                  if ((setIsFocused(!1), validateOnBlur)) {
              ...
              (lastIconSrc || (endIcon && "end" === iconPosition)) &&
                react.createElement(
                  ...
                  lastIconSrc
                    ? react.createElement("img", { src: lastIconSrc, alt: "end icon for input" })
                    : endIcon,
                ),
            ),
            (currentGuidMessage || currentSuccessMessage || currentErrorMessage) &&
              react.createElement(
                ...
                currentGuidMessage
                  ? react.createElement(
                      "p",
                      { className: "textField-guidMessage" },
                      currentGuidMessage,
                    )
                  : currentSuccessMessage
                    ? react.createElement(
                        "p",
                        { className: "textField-successMessage" },
                        currentSuccessMessage,
                      )
                    : currentErrorMessage
                      ? react.createElement(
                          "p",
                          { className: "textField-errorMessage" },
                          currentErrorMessage,
                        )
                      : null,
              ),
      ...
      TextField.__docgenInfo = {
        ...
        props: {
          type: {
            ...
            tsType: {
              name: "union",
              raw: '"email" | "number" | "password" | "tel" | "text" | "url"',
              elements: [
          ...
          minLength: { required: !1, tsType: { name: "number" }, description: "" },
          pattern: { required: !1, tsType: { name: "string" }, description: "" },
          autoComplete: { required: !1, tsType: { name: "string" }, description: "" },
          autoFocus: { required: !1, tsType: { name: "boolean" }, description: "" },
          tabIndex: { required: !1, tsType: { name: "number" }, description: "" },
          onKeyDown: {
            required: !1,
            tsType: {
              name: "signature",
          ...
          color: {
            ...
            tsType: {
              name: "union",
              raw: '"primary" | "secondary" | "error" | "warning" | "success"',
              elements: [
          ...
          mask: { required: !1, tsType: { name: "string" }, description: "" },
          allowOnlyNumbers: { required: !1, tsType: { name: "boolean" }, description: "" },
          allowOnlyLetters: { required: !1, tsType: { name: "boolean" }, description: "" },
        ...
        Advanced = {
          ...
          render: (args) => {
            ...
            return react.createElement(
              "div",
              { style: { width: "400px" } },
              react.createElement(TextField_TextField, {
                ...args,
                value,
                onChange: setValue,
                validationRules: [
                  { rule: (val) => val.length >= 3, message: "حداقل ۳ کاراکتر وارد کنید" },
                  {
                    rule: (val) => /^[a-zA-Z\u0600-\u06FF\s]+$/.test(val),
                    message: "فقط حروف مجاز است",
                  },
                ],
                onFocus: () => console.log("Focused"),
                onBlur: () => console.log("Blurred"),
                startIcon: react.createElement("span", null, "👤"),
                endIcon: react.createElement("span", null, "✓"),
            ...
            return react.createElement(
              ...
              react.createElement(TextField_TextField, {
                ...
                validationRules: [
                  ...
                  { rule: (val) => /^[a-zA-Z0-9]+$/.test(val), message: "فقط حروف و اعداد" },
                ],
                errorMessage:
                  value.length > 0 && value.length < 10 ? "کد ملی باید ۱۰ رقم باشد" : "",
              }),
            );
          },
        },
              ...
              react.createElement(TextField_TextField, {
                ...
                formatter: (val) => {
                  const cleaned = val.replace(/\D/g, ""),
                    match = cleaned.match(/^(\d{0,3})(\d{0,3})(\d{0,4})$/);
      ...
      ((Basic.parameters = {
        ...
        (Advanced.parameters = {
          ...Advanced.parameters,
          docs: {
            ...Advanced.parameters?.docs,
            source: {
              originalSource:
                '{\n  args: {\n    type: "text",\n    label: "نام کامل",\n    id: "fullname",\n    name: "fullname",\n    placeholder: "نام کامل خود را وارد کنید",\n    required: true,\n    maxLength: 50,\n    minLength: 2,\n    size: "lg",\n    variant: "outlined",\n    color: "primary",\n    fullWidth: true,\n    validateOnChange: true,\n    validateOnBlur: true,\n    allowOnlyLetters: true,\n    "aria-label": "نام کامل",\n    value: "",\n    onChange: () => {}\n  },\n  render: args => {\n    const [value, setValue] = useState("");\n    const validationRules = [{\n      rule: (val: string) => val.length >= 3,\n      message: "حداقل ۳ کاراکتر وارد کنید"\n    }, {\n      rule: (val: string) => /^[a-zA-Z\\u0600-\\u06FF\\s]+$/.test(val),\n      message: "فقط حروف مجاز است"\n    }];\n    return <div style={{\n      width: "400px"\n    }}>\r\n        <TextField {...args} value={value} onChange={setValue} validationRules={validationRules} onFocus={() => console.log("Focused")} onBlur={() => console.log("Blurred")} startIcon={<span>👤</span>} endIcon={<span>✓</span>} iconClick={() => console.log("Icon clicked")} />\r\n      </div>;\n  }\n}',
              ...Advanced.parameters?.docs?.source,
            },
          },
        }),
        (Sizes.parameters = {
        ...
        (WithValidation.parameters = {
          ...
          docs: {
            ...
            source: {
              originalSource:
                '{\n  args: {\n    type: "text",\n    label: "کد ملی",\n    id: "national-id",\n    placeholder: "کد ملی خود را وارد کنید",\n    required: true,\n    maxLength: 10,\n    minLength: 10,\n    pattern: "[0-9]{10}",\n    validateOnChange: true,\n    allowOnlyNumbers: true,\n    value: "",\n    onChange: () => {}\n  },\n  render: args => {\n    const [value, setValue] = useState("");\n    const validationRules = [{\n      rule: (val: string) => val.length >= 5,\n      message: "حداقل ۵ کاراکتر"\n    }, {\n      rule: (val: string) => /^[a-zA-Z0-9]+$/.test(val),\n      message: "فقط حروف و اعداد"\n    }];\n    return <div style={{\n      width: "400px"\n    }}>\r\n        <TextField {...args} value={value} onChange={setValue} validationRules={validationRules} errorMessage={value.length > 0 && value.length < 10 ? "کد ملی باید ۱۰ رقم باشد" : ""} />\r\n      </div>;\n  }\n}',
        ...
        (WithFormatting.parameters = {
          ...
          docs: {
            ...
            source: {
              originalSource:
                '{\n  args: {\n    type: "tel",\n    label: "شماره تلفن",\n    id: "phone",\n    placeholder: "شماره تلفن خود را وارد کنید",\n    allowOnlyNumbers: true,\n    value: "",\n    onChange: () => {}\n  },\n  render: args => {\n    const [value, setValue] = useState("");\n    const formatter = (val: string) => {\n      // Format as phone number\n      const cleaned = val.replace(/\\D/g, "");\n      const match = cleaned.match(/^(\\d{0,3})(\\d{0,3})(\\d{0,4})$/);\n      if (match) {\n        return [match[1], match[2], match[3]].filter(Boolean).join("-");\n      }\n      return cleaned;\n    };\n    return <div style={{\n      width: "400px"\n    }}>\r\n        <TextField {...args} value={value} onChange={setValue} formatter={formatter} startIcon={<span>📞</span>} />\r\n      </div>;\n  }\n}',
