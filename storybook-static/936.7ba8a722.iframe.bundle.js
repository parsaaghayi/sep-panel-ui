...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [936],
  {
    "./node_modules/@storybook/blocks/dist/Color-YHDXOIA2.mjs": (
      ...
      var _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
        ...
        storybook_internal_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          "./node_modules/@storybook/core/dist/components/index.js",
        ),
        storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        require_color_name = (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.P$)({
        ...
        require_conversions = (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.P$)({
          "../../node_modules/color-convert/conversions.js"(exports, module) {
            ...
            ((convert2.rgb.hsl = function (rgb) {
              ...
              let l2 = (min + max) / 2;
              return (
                (s2 = max === min ? 0 : l2 <= 0.5 ? delta / (max + min) : delta / (2 - max - min)),
                [h2, 100 * s2, 100 * l2]
              );
            }),
              ...
              (convert2.rgb.keyword = function (rgb) {
                ...
                for (let keyword of Object.keys(cssKeywords)) {
                  let value = cssKeywords[keyword],
                    distance =
                      ((y2 = value),
                      ((x2 = rgb)[0] - y2[0]) ** 2 + (x2[1] - y2[1]) ** 2 + (x2[2] - y2[2]) ** 2);
              ...
              (convert2.hsl.hsv = function (hsl) {
                ...
                return (
                  ...
                  [
                    h2,
                    100 * (0 === l2 ? (2 * smin) / (lmin + smin) : (2 * s2) / (l2 + s2)),
                    100 * ((l2 + s2) / 2),
                  ]
                );
              }),
              ...
              (convert2.hcg.rgb = function (hcg) {
                ...
                return (
                  (mg = (1 - c2) * g2),
                  [255 * (c2 * pure[0] + mg), 255 * (c2 * pure[1] + mg), 255 * (c2 * pure[2] + mg)]
                );
              }),
        ...
        require_route = (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.P$)({
        ...
        require_color_convert = (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.P$)({
        ...
        import_color_convert = (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.f1)(
      ...
      function Y(e2, t2, l2) {
        var u2 = i(l2),
          ...
          s2 = c2[0],
          f2 = c2[1],
          v2 = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)({ color: t2, hsva: s2 });
        ((0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(
          function () {
      ...
      var ColorSpace2,
        ...
        U = function (t2) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0__.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(T, { hsva: d2, onChange: h2 }),
        ...
        re = function (t2) {
          ...
          return react__WEBPACK_IMPORTED_MODULE_0__.createElement(
            ...
            u({}, s2, { ref: f2, className: m2 }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(T, { hsva: d2, onChange: h2 }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(S, { hue: d2.h, onChange: h2 }),
        ...
        Wrapper = storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          position: "relative",
          maxWidth: 250,
          '&[aria-readonly="true"]': { opacity: 0.5 },
        }),
        PickerTooltip = (0, storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
        ...
        TooltipContent = storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          width: 200,
          margin: 5,
        ...
        Swatches = storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div({
          display: "grid",
        ...
        SwatchColor = storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4.div(
          ({ theme, active }) => ({
            width: 16,
            height: 16,
            boxShadow: active
        ...
        ToggleIcon = (0, storybook_internal_theming__WEBPACK_IMPORTED_MODULE_2__.I4)(
        ...
        useColorInput = (initialValue, onChange) => {
          let [value, setValue] = (0, react__WEBPACK_IMPORTED_MODULE_0__.useState)(
            ...
            [color, setColor] = (0, react__WEBPACK_IMPORTED_MODULE_0__.useState)(() =>
              parseValue(value),
            ),
            [colorSpace, setColorSpace] = (0, react__WEBPACK_IMPORTED_MODULE_0__.useState)(
        ...
        ColorControl = ({
          ...
          let debouncedOnChange = (0, react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
              (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.sg)(onChange, 200),
              [onChange],
            ),
          ...
          return react__WEBPACK_IMPORTED_MODULE_0__.createElement(
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Input, {
              id: (0, _chunk_2PTXLE6R_mjs__WEBPACK_IMPORTED_MODULE_1__.ZA)(name),
              value,
