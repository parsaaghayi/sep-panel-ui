...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [807],
  {
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./src/components/Avatar/style.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ["webpack://./src/components/Avatar/style.css"],
            names: [],
            mappings:
              "AAAA;EACE,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,WAAW;EACX,YAAY;EACZ,kBAAkB;EAClB,gBAAgB;AAClB",
            sourcesContent: [
              ".avatar-container {\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n  width: 40px;\r\n  height: 40px;\r\n  border-radius: 50%;\r\n  overflow: hidden;\r\n}\r\n",
            ],
            sourceRoot: "",
    ...
    "./src/components/Avatar/Avatar.stories.tsx": (
      ...
      const avatar_namespaceObject = __webpack_require__.p + "static/media/avatar.78bb6b85.svg",
        Avatar = ({ picUrl, className }) =>
          react.createElement("div", {
            className: `avatar-container ${className || ""}`,
            style: {
              background: `lightblue url('${picUrl || avatar_namespaceObject}')`,
      ...
      Avatar.__docgenInfo = {
        ...
        displayName: "Avatar",
        props: {
          picUrl: { required: !1, tsType: { name: "string" }, description: "" },
          className: { required: !1, tsType: { name: "string" }, description: "" },
        },
      };
      const Avatar_stories = { title: "sep-panel-ui/Avatar", component: Avatar_Avatar },
        icon = { args: {} },
        pic = {
          args: {
            picUrl:
