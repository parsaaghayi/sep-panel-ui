...
(self.webpackChunk_parsaaghayi_sep_panel_ui =
  ...
  [61],
  {
    "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].use[1]!./src/components/Toggle/style.css":
      (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          module.id,
          ".toggle-container {\n  display: flex;\n  max-width: 32px;\n  height: 16px;\n  justify-content: center;\n  align-items: center;\n  border-radius: 16px;\n  border: 2px solid var(--Blue-B100, rgba(0, 0, 0, 0));\n  padding: 2px;\n  padding-bottom: 3px;\n}\n.toggle-container:active {\n  border: 2px solid var(--Blue-B100, #4c9aff);\n}\n.toggle-container .toggle-body {\n  cursor: pointer;\n}\n.toggle-container .toggle-body.not-active {\n  display: flex;\n  padding: 2px 2px 2px 6px;\n  justify-content: center;\n  align-items: center;\n  gap: 4px;\n  border-radius: 16px;\n  background: var(--neutral-light-n-200, #6b778c);\n}\n.toggle-container .toggle-body.not-active:hover {\n  background: var(--neutral-light-n-70, #a5adba);\n}\n.toggle-container .toggle-body.not-active.disable {\n  background: var(--neutral-light-n-20, #f4f5f7);\n  cursor: default;\n}\n.toggle-container .toggle-body.active {\n  display: inline-flex;\n  padding: 2px 2px 2px 6px;\n  justify-content: center;\n  align-items: center;\n  gap: 4px;\n  border-radius: 16px;\n  background: var(--Green-G400, #00875a);\n}\n.toggle-container .toggle-body.active:hover {\n  background: var(--Green-G300, #36b37e);\n}\n.toggle-container .toggle-body.active.disable {\n  background: var(--neutral-light-n-20, #f4f5f7);\n  cursor: default;\n}\n",
          "",
          {
            version: 3,
            sources: ["webpack://./src/components/Toggle/style.css"],
            names: [],
            mappings:
              "AAAA;EACE,aAAa;EACb,eAAe;EACf,YAAY;EACZ,uBAAuB;EACvB,mBAAmB;EACnB,mBAAmB;EACnB,oDAAoD;EACpD,YAAY;EACZ,mBAAmB;AACrB;AACA;EACE,2CAA2C;AAC7C;AACA;EACE,eAAe;AACjB;AACA;EACE,aAAa;EACb,wBAAwB;EACxB,uBAAuB;EACvB,mBAAmB;EACnB,QAAQ;EACR,mBAAmB;EACnB,+CAA+C;AACjD;AACA;EACE,8CAA8C;AAChD;AACA;EACE,8CAA8C;EAC9C,eAAe;AACjB;AACA;EACE,oBAAoB;EACpB,wBAAwB;EACxB,uBAAuB;EACvB,mBAAmB;EACnB,QAAQ;EACR,mBAAmB;EACnB,sCAAsC;AACxC;AACA;EACE,sCAAsC;AACxC;AACA;EACE,8CAA8C;EAC9C,eAAe;AACjB",
            sourcesContent: [
              ".toggle-container {\r\n  display: flex;\r\n  max-width: 32px;\r\n  height: 16px;\r\n  justify-content: center;\r\n  align-items: center;\r\n  border-radius: 16px;\r\n  border: 2px solid var(--Blue-B100, rgba(0, 0, 0, 0));\r\n  padding: 2px;\r\n  padding-bottom: 3px;\r\n}\r\n.toggle-container:active {\r\n  border: 2px solid var(--Blue-B100, #4c9aff);\r\n}\r\n.toggle-container .toggle-body {\r\n  cursor: pointer;\r\n}\r\n.toggle-container .toggle-body.not-active {\r\n  display: flex;\r\n  padding: 2px 2px 2px 6px;\r\n  justify-content: center;\r\n  align-items: center;\r\n  gap: 4px;\r\n  border-radius: 16px;\r\n  background: var(--neutral-light-n-200, #6b778c);\r\n}\r\n.toggle-container .toggle-body.not-active:hover {\r\n  background: var(--neutral-light-n-70, #a5adba);\r\n}\r\n.toggle-container .toggle-body.not-active.disable {\r\n  background: var(--neutral-light-n-20, #f4f5f7);\r\n  cursor: default;\r\n}\r\n.toggle-container .toggle-body.active {\r\n  display: inline-flex;\r\n  padding: 2px 2px 2px 6px;\r\n  justify-content: center;\r\n  align-items: center;\r\n  gap: 4px;\r\n  border-radius: 16px;\r\n  background: var(--Green-G400, #00875a);\r\n}\r\n.toggle-container .toggle-body.active:hover {\r\n  background: var(--Green-G300, #36b37e);\r\n}\r\n.toggle-container .toggle-body.active.disable {\r\n  background: var(--neutral-light-n-20, #f4f5f7);\r\n  cursor: default;\r\n}\r\n",
            ],
            sourceRoot: "",
    ...
    "./src/components/Toggle/Toggle.stories.tsx": (
      ...
      const cross_namespaceObject = __webpack_require__.p + "static/media/cross.8cfde2dc.svg",
        check_namespaceObject = __webpack_require__.p + "static/media/check.aa7cf137.svg",
        dot_namespaceObject = __webpack_require__.p + "static/media/dot.89511103.svg",
        Toggle = ({ status, disabled = !1, onChange }) =>
          react.createElement(
            "div",
            ...
            react.createElement(
              ...
              status
                ? react.createElement("img", { src: check_namespaceObject, alt: "check icon" })
                : react.createElement("img", { src: cross_namespaceObject, alt: "cross icon" }),
              react.createElement("img", { src: dot_namespaceObject, alt: "dot icon" }),
            ),
          ),
      ...
      Toggle.__docgenInfo = {
        ...
        displayName: "Toggle",
        props: {
          status: { required: !0, tsType: { name: "boolean" }, description: "" },
          disabled: {
            required: !1,
            tsType: { name: "boolean" },
            description: "",
      ...
      const Toggle_stories = { title: "sep-panel-ui/Toggle", component: Toggle_Toggle },
        test = { args: { status: !0, disabled: !0, onChange: () => console.log("hello") } },
